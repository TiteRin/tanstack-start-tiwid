...
INSERT INTO "new_DoneTask" ("doneAt", "id", "taskId", "userId") SELECT "doneAt", "id", "taskId", "userId" FROM "DoneTask";
DROP TABLE "DoneTask";
ALTER TABLE "new_DoneTask" RENAME TO "DoneTask";
...
INSERT INTO "new_Task" ("id", "label", "userId") SELECT "id", "label", "userId" FROM "Task";
DROP TABLE "Task";
